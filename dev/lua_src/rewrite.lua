-- rewrite to unsafe/filters:watermark(/mark/shirley_600.png,30,-400,0)/681/56/aa40e00cf7841dc28420f504eb0ca4dc.jpg
...
local function get_size(width,height)
    if width  > max_width or width == 0 then width = max_width end
    if height > max_width or height == 0 then height = max_height end
    return width,height
end
...
local real_path = "/" .. thumbor_key .. "/" .. width .. "x" .. height .. "/"
        .. filters .. "/" .. file_path
